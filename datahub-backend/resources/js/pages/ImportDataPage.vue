        ...
        <div class="content-container">
          ...
          <div class="page-header">
            ...
            <div class="breadcrumb">
              <span>DataHub</span> / <span class="active">Import</span>
            </div>
          </div>

          <div class="import-card">
            
            <div v-if="!file && !successMessage" 
                 class="upload-area" 
                 @dragover.prevent 
...
export default {
  ...
  methods: {
    ...
    validateFile(file) {
      ...
      // Validasi tipe file (MIME type atau ekstensi)
...
.import-card {
  ...
  padding: 3rem; min-height: 400px; display: flex; flex-direction: column; align-items: center; justify-content: center;
}
...
.file-info-card {
  display: flex; align-items: center; background: #f1f5f9; padding: 1rem;
  border-radius: 10px; margin-bottom: 1.5rem; text-align: left;
}
...
.btn-primary {
  background: #1B2376; color: white; border: none; padding: 0.8rem 2rem;
  border-radius: 8px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 0.5rem;
}
.btn-secondary {
  background: white; border: 1px solid #e2e8f0; color: #64748b; padding: 0.8rem 2rem;
